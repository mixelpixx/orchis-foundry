...
function OrchisNav({
  ...
  return /*#__PURE__*/React.createElement("nav", {
    ...
    href: "https://orchis.ai",
    style: navStyles.brand,
    "aria-label": "orchis.ai home"
  }, /*#__PURE__*/React.createElement("span", {
    style: navStyles.mark,
    "aria-hidden": "true"
  }, /*#__PURE__*/React.createElement("span", {
    style: navStyles.markInner
  })), /*#__PURE__*/React.createElement("span", null, "orchis", /*#__PURE__*/React.createElement("span", {
    style: navStyles.dot
  }, "."), "ai")), /*#__PURE__*/React.createElement("ul", {
    ...
    style: navStyles.aux
  }, showAdmin ? /*#__PURE__*/React.createElement("a", {
    href: "https://admin.orchis.ai",
    style: navStyles.admin,
    title: "Open admin console"
  }, /*#__PURE__*/React.createElement("span", {
    style: navStyles.adminDot,
    "aria-hidden": "true"
  }), "admin") : null));
}
const navStyles = {
...
function inlineMd(s) {
  return escapeHtml(s).replace(/`([^`]+)`/g, "<code style=\"font-family: var(--font-mono); background: var(--bg-2); padding: 1px 5px; border-radius: 4px; font-size: 0.9em;\">$1</code>").replace(/\*\*([^*]+)\*\*/g, "<strong>$1</strong>")
...
function AccountPanel() {
  ...
  const applyMe = u => {
    ...
    if (window.USERS && USERS.me) {
      ...
      USERS.me.avatarUrl = u.avatarUrl;
    }
  ...
  const uploadAvatar = async file => {
    ...
    try {
      ...
      const r = await fetch("/v1/me/avatar", {
        method: "POST",
        credentials: "same-origin",
        body: fd
      });
      ...
      setErr("Could not upload — use a png/jpeg/gif/webp under 512 KB.");
    } finally {
      setAvatarBusy(false);
  ...
  }, me.email || "no email on file")), /*#__PURE__*/React.createElement("input", {
    ref: fileRef,
    type: "file",
  ...
  }, avatarBusy ? "Uploading…" : "Change photo"), me.avatarUrl ? /*#__PURE__*/React.createElement("button", {
    className: "btn ghost sm",
    style: {
      color: "var(--danger)"
    },
    onClick: removeAvatar
  }, "Remove") : null), /*#__PURE__*/React.createElement(Field, {
    label: "Display name"
  }, /*#__PURE__*/React.createElement("input", {
    className: "input",
    value: name,
...
function App() {
  ...
  React.useEffect(() => {
    ...
    window.OrchisAPI.get("/v1/me/preferences").then(p => {
      ...
      if (p.theme === "light" || p.theme === "dark") {
        ...
        localStorage.setItem("orchis-theme", p.theme);
      }
      const tw = {};
      ["accent", "density", "font"].forEach(k => {
        if (p[k] != null) tw[k] = p[k];
      });
  ...
  return /*#__PURE__*/React.createElement("div", {
    style: appStyles.outer
  }, /*#__PURE__*/React.createElement(OrchisNav, {
    siteHandle: "foundry"
  }), /*#__PURE__*/React.createElement("div", {
