...
function App() {
  ...
  // Render current view
  let view;
  if (route.view === "home") view = <DashboardView setRoute={navigate} openPalette={() => setPaletteOpen(true)} />;
  ...
  else view = <DashboardView setRoute={navigate} openPalette={() => setPaletteOpen(true)} />;
